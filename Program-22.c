...
int main()
{
    ...
    struct NODE *start, *rear, *new_node, *Temp, *display; // Variables declaration to perform creation of a new node and deletion operation at the end of singly linked list
    ...
    if (!total_node)
    {
        ...
        printf("\nReady for deletion from the end of the list... ");
        system("pause");
        ...
        do // Loop to perform deletioin of nodes from the end of the list
        {
            if (!(start->Next))
            {
                start = NULL;
            ...
            Temp = start; // Assign the beginning node of list to Temp
            ...
            free(Temp->Next); // Delete node to which temp is pointing, This will delete the node currently at the end as Temp->Next points to the node currently at the end of the list

            printf("\n1 Node deleted from end... \n");
            printf("The list now is:\n");
            printf("\n");
